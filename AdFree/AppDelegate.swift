...
//  AppDelegate.swift
//  AdFree: AdFree
//  com.maximpuchkov.Untitled 1.AdFree.AppDelegate
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        // Reload content blocker whenever app launches
        let id = "com.maximpuchkov.AdFree.Blocker"
        SFContentBlockerManager.reloadContentBlocker(withIdentifier: id) { error in
            ...
            print("OK: Content blocker reloaded.")
        }
